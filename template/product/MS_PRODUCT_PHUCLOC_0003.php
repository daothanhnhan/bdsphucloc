...
<div class="gb-page-sanpham_ruouvang">
    <div class="container">
        <div class="col-md-9">
            <?php include DIR_SEARCH."MS_SEARCH_PHUCLOC_0001.php";?>
            <div class="row">
                <div class="col-sm-4">
                    <div class="gb-product_ruouvang-item">
                        ...
                        <div class="gb-product_ruouvang-item-text">
                            ...
                            <!--PRICE-->
                            <?php include DIR_PRODUCT."MS_PRODUCT_PHUCLOC_0002.php";?>
                        </div>
                        <div class="gb-product_ruouvang-item-yeumua">
                            <!--YÊU THÍCH-->
                            <?php include DIR_CART."MS_CART_PHUCLOC_0003.php";?>
                            <!--MUA HÀNG-->
                            <?php include DIR_CART."MS_CART_PHUCLOC_0001.php";?>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
        ...
        <div class="col-md-3">
            ...
            <?php include DIR_SIDEBAR."MS_SIDEBAR_PHUCLOC_0006.php";?>
            <?php include DIR_SIDEBAR."MS_SIDEBAR_PHUCLOC_0007.php";?>
            <?php include DIR_SIDEBAR."MS_SIDEBAR_PHUCLOC_0008.php";?>
