           ...
           <li><a href="index.php?page=bai-viet" title=""
            ...
            <li><a href="index.php?page=dich-vu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dich-vu' || $_GET["page"] == 'them-dich-vu' || $_GET["page"] == 'sua-dich-vu') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Danh sách dự án</a></li>
            ...
            <li><a href="index.php?page=mau-nha" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Mẫu nhà</a>
            </li>

            <li><a href="index.php?page=dat-lich-hen" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đặt lịch hẹn</a>
            </li>

            <li><a href="index.php?page=hoi-dong" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đội ngũ lãnh đạo</a>
            </li>

            <li><a href="index.php?page=dieu-hanh" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Ban điều hành</a>
            </li>
