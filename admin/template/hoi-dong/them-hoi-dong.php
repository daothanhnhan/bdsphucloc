<?php 
	...
	function hoi_dong () {
		...
		if (isset($_POST['add_hoidong'])) {
			...
			$sql = "INSERT INTO hoi_dong (name, sex, position, image) VALUES ('$name', '$sex', '$position', '$image')";
			$result = mysqli_query($conn_vn, $sql);
			echo '<script type="text/javascript">alert(\'Bạn đã thêm Chức vụ thành công.\');window.location.href="/admin/index.php?page=hoi-dong"</script>';
		}
	}
