        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ///////////// mau nha //////////////
                    case "mau-nha":
                        include_once("template/mau-nha/mau-nha.php");
                        break;

                    case "them-mau-nha":
                        include_once("template/mau-nha/them-mau-nha.php");
                        break;

                    case "sua-mau-nha":
                        include_once("template/mau-nha/sua-mau-nha.php");
                        break;

                    case "xoa-mau-nha":
                        include_once("template/mau-nha/xoa-mau-nha.php");
                        break;
                    /////////////// dat lich hen ///////////
                    case "dat-lich-hen":
                        include_once("template/dat-lich-hen.php");
                        break;
                    /////////////// hoi dong //////////////
                    case "hoi-dong":
                        include_once("template/hoi-dong/hoi-dong.php");
                        break;
                    case "them-hoi-dong":
                        include_once("template/hoi-dong/them-hoi-dong.php");
                        break;
                    case "sua-hoi-dong":
                        include_once("template/hoi-dong/sua-hoi-dong.php");
                        break;
                    case "xoa-hoi-dong":
                        include_once("template/hoi-dong/xoa-hoi-dong.php");
                        break;
                    /////////////// ban diều hành //////////////
                    case "dieu-hanh":
                        include_once("template/dieu-hanh/dieu-hanh.php");
                        break;
                    case "them-dieu-hanh":
                        include_once("template/dieu-hanh/them-dieu-hanh.php");
                        break;
                    case "sua-dieu-hanh":
                        include_once("template/dieu-hanh/sua-dieu-hanh.php");
                        break;
                    case "xoa-dieu-hanh":
                        include_once("template/dieu-hanh/xoa-dieu-hanh.php");
                        break;
                    ///////////// Default /////////////////
                    default:
