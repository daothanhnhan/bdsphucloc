...
public function getServiceList_byMultiLevel_orderServiceId_1($idServiceCat,$order_serviceId,$trang, $limit, $page){
    ...
    $sql = "SELECT * From $table $where $order $limit1";//echo $sql;
